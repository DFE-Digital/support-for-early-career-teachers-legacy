...
mentor = User.find("53960d7f-1308-4de1-a56d-de03ea8e1d9c").core_induction_programme

CoreInductionProgramme.find(mentor.id).update!(course_year_one_id: year.id, course_year_two_id: year.id)
