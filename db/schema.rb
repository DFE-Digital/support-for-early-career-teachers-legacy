...
ActiveRecord::Schema.define(version: 2022_02_09_134701) do
  ...
  create_table "api_metadata", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  ...
  create_table "early_career_teacher_profiles", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.boolean "guidance_seen", default: false
  ...
  create_table "external_user_profiles", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.uuid "user_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["user_id"], name: "index_external_user_profiles_on_user_id"
  end
  ...
  add_foreign_key "external_user_profiles", "users"
